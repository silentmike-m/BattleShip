namespace BattleShip.Application.Commons.Constants;

public static class ErrorCodes
{
    public static readonly string CELL_ALREADY_FIRED = "cell_already_fired";
    public static readonly string CELL_NOT_FOUND = "cell_not_found";
